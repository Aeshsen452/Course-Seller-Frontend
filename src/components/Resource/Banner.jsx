          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left space-y-4">
              <h1 className="textFont text-3xl sm:text-4xl lg:text-5xl xl:text-8xl  leading-tight text-black">
                Kitehawk Program Resources
              </h1>

              <p className="text-sm sm:text-base leading-relaxed max-w-2xl mx-auto lg:mx-0">
                The Kitehawk Literacy Program is a popular home schooling
                program in Australia. Each level follows the same clear
                structure, helping students feel confident as they learn.
                Activities become harder gradually, making learning easier for
                both students and parents. Short concept summaries and answers
                are provided, and feedback is always welcome.
              </p>
